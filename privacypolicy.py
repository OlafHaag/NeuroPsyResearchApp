...
def get_policy():
    ...
    "This privacy policy explains our handling, use and disclosure of certain information."
    "\n\n"
    ...
    "the time of day the study was conducted, and measures such as reaction times and scores."
    "\n\n"
    ...
    "\n\n"
    "### Personal Data\n"
    "The {appname} app collects voluntary information about the age group and gender of the participants. "
    "The {appname} app does **not** collect sensitive or personally identifiable information such as a user's name, "
    "address, telephone number, passwords, payment details, or social security number. "
    "Therefore, the information cannot be used to identify a natural person and is thus not considered personal data "
    "(Recital 26 GDPR).  \n"
    ...
    "own being able to identify a specific person. The voluntary information about age group and gender of "
    "participants are used to assess the representativeness of the research data. The fully anonymized data from these "
    "studies are made available on the Internet as open data under the "
