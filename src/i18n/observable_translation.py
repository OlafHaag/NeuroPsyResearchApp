...
This module is taken from https://github.com/fossasia/kniteditor/tree/master/kniteditor/localization under terms of the
LGPL-3.0, see LICENSE file in this module.
"""
